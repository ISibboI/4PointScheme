...
public class TangentCurve extends FourPointCurve {
	...
	public void setTangent(int i, Line tangent) {
		_tangents[i] = tangent;
	}
	...
	@Override
	public TangentCurve subdivide(PointSelector pointSelector, int step) {
