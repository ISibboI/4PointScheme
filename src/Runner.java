...
public class Runner {
	public static void main(String[] args) throws InterruptedException {
		...
		Curve startingPoints = new TangentCurve(new Point[] { new Point(0, 0), new Point(1, 3), new Point(11, 4),
				new Point(111, 3), new Point(121, 0) }, 1.0 / 16.0, 0.9, new DefaultTangentChooser());
		int iterations = 10;
